...
Bu bölümde verinin boş gözlem bulunmayan son hali analiz edilecektir. Önce verinin kaç satır ve sütun olduğuna bakılacaktır. Ardından verinin özet istatistikleri, regresyon modeli ve bu modelin sonuçlarını özetleme seklinde olacaktır.
